...
There are three types of configuration layers:
  ...
  - layers (in the =layers= directory, those layers are contributions shared
...
For instance to add the configuration layer of [[../contrib/themes-megapack][themes-megapack]]:
...
support. For instance the [[../layers/+source-control/git][git layer]] has several configuration variables, they
