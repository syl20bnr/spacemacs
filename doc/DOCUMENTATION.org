...
| File           | Usage                                                                                    |
|----------------+------------------------------------------------------------------------------------------|
| config.el      | Layer configuration (defines the list of package for the layer and layer variables)      |
...
| packages.el    | The actual configuration of the packages (defines the functions init, post-init, etc...) |
