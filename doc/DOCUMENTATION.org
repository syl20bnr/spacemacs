 ...
 - [[#commands][Commands]]
   ...
   - [[#navigating][Navigating]]
     ...
     - [[#buffers-and-files][Buffers and Files]]
       ...
       - [[#frame-manipulations-key-bindings][Frame manipulations key bindings]]
...
**** Frame manipulations key bindings
Frame manimpulation commands (start with ~F~):

| Key Binding | Description                                                                |
|-------------+----------------------------------------------------------------------------|
| ~SPC F f~   | open file in another frame                                                 |
| ~SPC F c~   | delete the current frame (the frame will stay open if there are no others) |
| ~SPC F C~   | delete all other frames                                                    |
| ~SPC F b~   | open buffer in a new frame                                                 |
| ~SPC F B~   | open buffer in a new frame, but don't switch                               |
| ~SPC F o~   | switch to next frame                                                       |
| ~SPC F d~   | open dired in a new frame                                                  |
| ~SPC F n~   | create new frame with the current buffer                                   |
