* Spacemacs Documentation                                              :TOC@4:
 ...
 - [[#dotfile-configuration][Dotfile Configuration]]
   ...
   - [[#when-things-go-wrong-troubleshooting-dotfile-problems][When things go wrong: Troubleshooting Dotfile problems]]
...
** When things go wrong: Troubleshooting Dotfile problems
* Main principles
** Editing Styles
*** Vim
