...
* Core Pillars
Four core pillars: Mnemonic, Discoverability, Consistency, "Crowd-Confi".
...
[[https://github.com/kai2nenobu/guide-key][which-key]] is enabled by default, it will display all the available key bindings
...
enjoyable:
  ...
  - a [[https://github.com/kai2nenobu/guide-key][which-key]] buffer
...
By default the [[https://github.com/kai2nenobu/guide-key][which-key]] buffer will be displayed quickly after the key has been
