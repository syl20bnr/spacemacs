...
| ~SPC p x e~ | Run eshell in project root. (projectile-run-eshell)     |
| ~SPC p x s~ | Run shell in project root. (projectile-run-shell)       |
| ~SPC p x t~ | Run term in project root. (projectile-run-term)         |
| ~SPC p y~   | find tags                                               |
