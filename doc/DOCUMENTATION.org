...
features. For instance the [[../layers/%2Bsource-control/git][git layer]] has several configuration variables, they
...
| ~SPC x d b~   | delete blank lines                                            |
| ~SPC x d d~   | delete duplicate lines                                        |
| ~SPC x d l~   | delete line                                                   |
| ~SPC x d L~   | delete whole line                                             |
| ~SPC x d p~   | delete paragraph                                              |
| ~SPC x d r~   | delete region                                                 |
| ~SPC x d s~   | delete sentence                                               |
| ~SPC x d S~   | delete s-expression                                           |
| ~SPC x d w~   | delete trailing whitespaces                                   |
| ~SPC x d z~   | delete all characters up to the given character               |
...
| ~SPC x m b~   | mark whole buffer                                             |
| ~SPC x m f~   | mark a function                                               |
| ~SPC x m m~   | set mark at cursor                                            |
| ~SPC x m p~   | mark paragraph                                                |
| ~SPC x m P~   | mark page                                                     |
| ~SPC x m s~   | mark end of sentence                                          |
| ~SPC x m S~   | mark s-expression                                             |
...
| ~SPC i y~   | insert most recent item in kill-ring                                  |
