...
To bind a command to a [[ https://www.emacswiki.org/emacs/KeyChord][key chord]] (a sequence of keys pressed quickly), use the =:chords=
keyword in the =use-package= definition. For example, to add key chords for [[https://github.com/winterTTr/ace-jump-mode/tree/8351e2df4fbbeb2a4003f2fb39f46d33803f3dac][Ace Jump]], you might have:
...
Be sure to also include and enable the key chord package itself:
