...
Four special functions in the =~/.spacemacs= file can be used to perform
...
*** Vim
Spacemacs behaves like in Vim using the [[https://gitorious.org/evil/pages/Home][Evil]] mode package to emulate Vim key bindings.
