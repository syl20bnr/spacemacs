...
This is a feature of Spacemacs, enabling you to easily switch between =insert
state= and =normal state=. The sequence of characters used can be customized.
See the [[http://spacemacs.org/doc/DOCUMENTATION.html#orgheadline78][documentation]] for more information.
