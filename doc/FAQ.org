...
* FAQ                                                       :TOC_4_org:noexport:
 ...
 - [[How do I...][How do I...]]
   ...
   - [[Make spell-checking supports curly quotes (or any other character)?][Make spell-checking supports curly quotes (or any other character)?]]
 - [[Windows][Windows]]
...
** Make spell-checking supports curly quotes (or any other character)?
To have spell-checking supporting curly quotes (or any other character), you
need to add a new entry to =ispell-local-dictionary-alist=, by adding the
