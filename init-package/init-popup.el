...
;; solarized
(custom-set-faces
 '(popup-face ((t (:background "#586e75" :foreground "#000000" :box (:line-width -1 :style released-button)))))
 '(popup-menu-face ((t (:background "#586e75" :foreground "#000000" :box (:line-width -1 :style released-button)))))
 ...
 '(popup-scroll-bar-foreground-face ((t (:background "#002b36" :box (:line-width -1 :style released-button)))))
