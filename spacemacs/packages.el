...
(defmacro spacemacs/use-package (functionname &rest ARGS)
  "Simplified init function generator"
  (declare (indent 1))
  (let ((package-string (if (stringp functionname) functionname (symbol-name functionname))))
    (if (null ARGS)
        `(progn (defun ,(intern (concatenate 'string "spacemacs/init-" package-string)) ()
...
(spacemacs/use-package ace-link
...
(spacemacs/use-package ace-window
  :defer t
  :init
  (evil-leader/set-key
    "bM"  'ace-swap-window
...
(spacemacs/use-package adaptive-wrap
  :config
  (add-hook 'visual-line-mode-hook 'adaptive-wrap-prefix-mode))


(spacemacs/use-package aggressive-indent
  :defer t
  :init
...
(spacemacs/use-package auto-dictionary
  :disabled t
  :defer t
  :init
...
(spacemacs/use-package auto-highlight-symbol
  :defer t
  :init
...
(spacemacs/use-package bookmark
  :defer t
  :init
...
(spacemacs/use-package buffer-move
  :defer t
  :init
  (evil-leader/set-key
    "bmh" 'buf-move-left
...
(spacemacs/use-package clean-aindent-mode
  :defer t
  :init
  (add-hook 'prog-mode-hook 'clean-aindent-mode))


(spacemacs/use-package desktop
  :defer t
  :config
...
(spacemacs/use-package dired+ :defer t)


(spacemacs/use-package doc-view
  :defer t
  :init
...
(spacemacs/use-package evil-anzu
  :init
  (global-anzu-mode t)
  :config
...
(spacemacs/use-package evil-args
  :init
...
(spacemacs/use-package evil-escape
  :init
  (evil-escape-mode)
  :config
...
(spacemacs/use-package evil-exchange
...
(spacemacs/use-package evil-indent-textobject)


(spacemacs/use-package evil-jumper
  :init
...
(spacemacs/use-package evil-leader
  :init
...
(spacemacs/use-package evil-lisp-state
  :init
  (setq evil-lisp-state-global t)
  (setq evil-lisp-state-leader-prefix "k"))


(spacemacs/use-package evil-nerd-commenter
...
(spacemacs/use-package evil-matchit
  :defer t)


(spacemacs/use-package evil-numbers
  :config
...
(spacemacs/use-package evil-search-highlight-persist
  :init
...
(spacemacs/use-package evil-surround
  :init
...
(spacemacs/use-package evil-tutor
...
(spacemacs/use-package evil-visualstar
...
(spacemacs/use-package exec-path-from-shell
  :init (when (memq window-system '(mac ns x))
          (exec-path-from-shell-initialize)))


(spacemacs/use-package expand-region
  :defer t
  :init
...
(spacemacs/use-package fancy-battery
  :defer t
  :init
...
(spacemacs/use-package fill-column-indicator
  :defer t
  :init
...
(spacemacs/use-package golden-ratio
  :defer t
  :init
...
(spacemacs/use-package google-translate
...
(spacemacs/use-package guide-key-tip
  :init
...
(spacemacs/use-package helm-descbinds
  :defer t
  :init
...
(spacemacs/use-package helm-make
  :defer t
  :init
  (evil-leader/set-key "hk" 'helm-make))


(spacemacs/use-package helm-mode-manager
  :defer t
  :init
  (evil-leader/set-key
...
(spacemacs/use-package helm-projectile
...
(spacemacs/use-package helm-swoop
  :defer t
  :init
...
(spacemacs/use-package helm-themes
  :defer t
  :init
  (evil-leader/set-key
    "Th" 'helm-themes))
...
(spacemacs/use-package highlight-indentation
  :defer t
  :init
...
(spacemacs/use-package highlight-numbers
  :defer t
  :init
...
(spacemacs/use-package highlight-parentheses
  :defer t
  :init
...
(spacemacs/use-package hl-anything
  :defer t
  :init
...
(spacemacs/use-package hungry-delete
  :defer t
  :init
...
(spacemacs/use-package ido-vertical-mode
  :init
  (ido-vertical-mode t)
...
(spacemacs/use-package iedit :defer t)


(spacemacs/use-package indent-guide
  :defer t
  :init
...
(spacemacs/use-package open-junk-file
  :defer t
...
(spacemacs/use-package leuven-theme
  :defer t
  :init (setq org-fontify-whole-heading-line t))


(spacemacs/use-package linum-relative
...
(spacemacs/use-package move-text
  :defer t
  :init
...
(spacemacs/use-package page-break-lines
  :init
  (global-page-break-lines-mode t)
  (spacemacs|hide-lighter page-break-lines-mode))


(spacemacs/use-package paradox
...
(spacemacs/use-package popup
  :defer t)


(spacemacs/use-package popwin
  :init
  (popwin-mode 1)
...
(spacemacs/use-package powerline
  :init
...
(spacemacs/use-package projectile
...
(spacemacs/use-package rainbow-delimiters
  :defer t
  :init
...
(spacemacs/use-package rfringe :defer t)


(spacemacs/use-package smartparens
  :defer t
  :init
...
(spacemacs/use-package undo-tree
  :init
...
(spacemacs/use-package vi-tilde-fringe
  :if window-system
  :init
...
(spacemacs/use-package visual-regexp-steroids  :defer t)
...
(spacemacs/use-package volatile-highlights
  :config
  (volatile-highlights-mode t)
  (spacemacs|hide-lighter volatile-highlights-mode))


(spacemacs/use-package wand
  :disabled t
  :init
  (require 'wand)
...
(spacemacs/use-package window-numbering
