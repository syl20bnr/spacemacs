...
(defun spacemacs/init-evil ()
  (use-package evil
    ...
    (progn
      ...
      ;; quick navigation
      (defun center-page-up ()
          (interactive)
          (evil-window-top)
          (let ((recenter-redisplay nil))
            (recenter nil)))
      (defun center-page-down ()
          (interactive)
          (evil-window-bottom)
          ...
          (let ((recenter-redisplay nil))
            (recenter nil)))
      (spacemacs|define-micro-state center-page-scroll
        :doc "[h] [H] page-up [l] [L] page-down"
        :bindings
        ("H" center-page-up)
        ("h" center-page-up)
        ("L" center-page-down)
      ...
      (define-key evil-normal-state-map (kbd "L")
        (lambda ()
          (interactive)
          (center-page-down)
          (spacemacs/center-page-scroll-micro-state)))
