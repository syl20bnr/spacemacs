...
(defun spacemacs/init-popwin ()
  (use-package popwin
    ...
    (progn
      ...
      (push '("*Help*"                 :dedicated t :position bottom :stick t nil t :height 0.4) popwin:special-display-config)
      (push '("*compilation*"          :dedicated t :position bottom :stick t nil t :height 0.4) popwin:special-display-config)
      (push '("*Shell Command Output*" :dedicated t :position bottom :stick t nil t            ) popwin:special-display-config)
      (push '("*Async Shell Command*"  :dedicated t :position bottom :stick t nil t            ) popwin:special-display-config)
      (push '(" *undo-tree*"           :dedicated t :position bottom :stick t nil t :height 0.4) popwin:special-display-config)
      (push '("*ert*"                  :dedicated t :position bottom :stick t nil t            ) popwin:special-display-config)
      (push '("*grep*"                 :dedicated t :position bottom :stick t nil t            ) popwin:special-display-config)
      (push '("*nosetests*"            :dedicated t :position bottom :stick t nil t            ) popwin:special-display-config)
