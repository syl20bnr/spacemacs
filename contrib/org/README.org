...
| Key Binding   | Description       |
|---------------+-------------------|
| ~SPC m t t f~ | recalculate field |
| ~SPC m t t b~ | recalculate table |
| ~SPC m t i r~ | insert row        |
| ~SPC m t i c~ | insert column     |
| ~SPC m t i h~ | insert hline      |
| ~SPC m t k r~ | kill row          |
| ~SPC m t k c~ | kill column       |
|               |                   |
