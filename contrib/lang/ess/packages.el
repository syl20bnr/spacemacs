...
(when ess-enable-smart-underscore
  (add-to-list 'ess-packages 'ess-smart-underscore))
...
(defun ess/init-ess-smart-equals ()
  (use-package ess-smart-equals
    :defer t
    :if ess-enable-smart-underscore
    :init
    (add-hook 'ess-mode-hook 'ess-smart-equals-mode)
    (add-hook 'inferior-ess-mode-hook 'ess-smart-equals-mode)))

(defun ess/init-ess-smart-underscore ()
  (use-package use-package ess-smart-underscore
    :defer t
    :if ess-enable-smart-underscore))
