...
* Table of Contents                                                   :TOC@4:
 ...
 - [[#install][Install]]
   ...
   - [[#enable-rtags-support][Enable Rtags support]]
...
- Support rtags, a ctags-like source code cross-referencer with a clang frontend [[https://github.com/Andersbakken/rtags][rtags]] 
...
** Enable Rtags support

[[https://github.com/Andersbakken/rtags][rtags]]

To enable Rtags support set the layer variable =c-c++-enable-rtags-support=
to =t= in the dotfile:
