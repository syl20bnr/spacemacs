...
** 0.200.1 (2016/10/09)
*** Fixes
- Fix =spacemacs/ert-run-tests-buffer= to run only the tests in current buffer
  (thanks to bmag)
*** Dotfile changes
...
*** Improvements
- Add support for transparency in multiple frames (thansk to TGThorax)
