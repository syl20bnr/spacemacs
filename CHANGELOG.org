...
- Git: new key bindings scheme using =evil-magit= package. To continue
  to use the old evilified bindings add =evil-magit= package to the
  =dotspacemacs-excluded-packages= variable of your dotfile.
...
- Typos and documentation improvements (thanks to AdrieanKhisbe, bardec,
  ...
  eagleflo, ernestas, Immortalin, jrk, justbur, masukomi, MaxWofford,
  mbertheau, mineo, mijoharas, mkollaro, nashamri, pbzdyl, person808,
  robbyoconnor, shishkin, swaroopch, TheBB, vijaykiran, xfq, xtian, ZachLiss)
*** Core team members
