...
- =erlang/elixir= layer has been split into two layer =erlang= and
...
- Revert ~C-o~ in =holy-mode= since it shadows to much packages key bindings
  (thanks to tuhdo)
...
- Update configuration to support new =alchemist= feature (thanks to tonini)
...
- Typos and documentation improvements (thanks to cloudbring, dxnn,
  dvberkel, fotoetienne, JoshTGreenwood, person808)
* Release 0.102.x
** 0.102.2 (2015/06/03)
*** Layer changes
**** Org
