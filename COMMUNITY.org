...
- This community is a community of hackers based on meritocracy and
  ...
  so does the Space-macs community.
- Be good in what you bring to the project be it code, documentation, typo
  ...
  difference in a wide variety of domains and occasions, [[https://github.com/syl20bnr/space-macs/blob/develop/doc/DOCUMENTATION.org#special-titles][see it for yourself]].
  Why not you? Make it happen, make history!
- Think you are not good enough? Find support and mentors by chatting on Gitter
  with fellow Space-macs users or just open an issue on GitHub, you will find
...
- The majority of the interactions with the community happens on GitHub via
  issues and on Gitter via the official Space-macs channel. There is also an
  active official twitter account =space-macs=.
...
part in Space-macs is the evil mode :-)
...
Space-macs GitHub repository, official Space-macs Gitter channels and Twitter
official Space-macs account timeline) are completely detached from their
...
|------------+-----------+--------+-------+-----------------------------------------------------------------|
| 2016/01/27 | syl20bnr  | lock   | #3484 | comments judged to be offending towards the Space-macs community |
