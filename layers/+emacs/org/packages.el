...
(defun org/init-org ()
  ;; Org ships with a special autoloads file called `org-loaddefs.el', which
  ;; contains data not found in `org-plus-contrib-autoloads.el' (which is
  ;; generated by the package system). Only the latter is loaded automatically,
  ;; therefore make sure to load the former.
