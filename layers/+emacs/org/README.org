...
| Key Binding | Description                                    |
|-------------+------------------------------------------------|
| ~SPC m r r~ | =verb-send-request-on-point-other-window-stay= |
| ~SPC m r s~ | =verb-send-request-on-point-other-window=      |
| ~SPC m r m~ | =verb-send-request-on-point-no-window=         |
| ~SPC m r f~ | =verb-send-request-on-point=                   |
| ~SPC m r k~ | =verb-kill-all-response-buffers=               |
| ~SPC m r e~ | =verb-export-request-on-point=                 |
| ~SPC m r u~ | =verb-export-request-on-point-curl=            |
| ~SPC m r b~ | =verb-export-request-on-point-verb=            |
| ~SPC m r n~ | =verb-export-request-on-point-human=           |
| ~SPC m r v~ | =verb-set-var=                                 |

*** verb-response-body-mode bindings

| Key Binding | Description                            |
|-------------+----------------------------------------|
| ~SPC m r r~ | =verb-toggle-show-headers=             |
| ~SPC m r k~ | =verb-kill-response-buffer-and-window= |
| ~SPC m r f~ | =verb-re-send-request=                 |

*** verb-response-headers-mode bindings

| Key Binding | Description                   |
|-------------+-------------------------------|
| ~SPC m r q~ | =verb-kill-buffer-and-window= |
