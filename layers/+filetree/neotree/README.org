...
add =neotree= to the existing =dotspace-macs-configuration-layers= list in this
file.
...
See [[https://github.com/jaypei/e-macs-neotree/issues/126]] for more information.

* Usage
This layer provides a quick and simple way to navigate in an unknown project
file tree with [[https://github.com/jaypei/e-macs-neotree][NeoTree]].
...
current state. With default =space-macs-dark= theme:
- green: new file
