...
* Configuration
** Follow mode
To have treemacs automatically sync with your current buffer's file set the layer variable
=treemacs-use-follow-mode= to =t=. To have treemacs automatically sync with your current tag set the
layer variable =treemacs-use-follow-mode= to =tag=.
