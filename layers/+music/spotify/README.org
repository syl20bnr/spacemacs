...
add =spotify= to the existing =dotspace-macs-configuration-layers= list in this
file.
...
If [[https://github.com/e-macs-helm/helm][Helm]] layer is enabled, you can also use the following binding(s):
