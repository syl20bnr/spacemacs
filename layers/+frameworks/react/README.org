...
add =react= to the existing =dotspace-macs-configuration-layers= list in this
file.
...
=dotspace-macs/user-init= function:
...
Check the [[https://github.com/syl20bnr/space-macs/blob/develop/layers/+lang/javascript/README.org#key-bindings][javascript layers documentation]] for additional key bindings.
