;;; packages.el --- twitter Layer packages File for Space-macs
;;
...
(defun twitter/init-twittering-mode ()
  (use-package twittering-mode
    ...
    :init
    (progn
      (space-macs/set-leader-keys "awt" 'twit)
      (setq twittering-initial-timeline-spec-string '(":home")
            ...
            twitter-images-directory (concat space-macs-cache-directory "twitter")
    ...
    (progn
      ...
      (let ((map twittering-mode-map))
        (define-key map "?"   'space-macs/twittering-mode-transient-state/body)
      ...
      (space-macs|define-transient-state twittering-mode
