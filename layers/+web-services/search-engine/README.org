...
add =search-engine= to the existing =dotspace-macs-configuration-layers= list in this
file.
...
* Customize it!
If you'd rather have e-macs use chrome, or firefox or any other thing (=eww=) you
...
following datastructure to =search-engine-config-list= in your =dotspace-macs/user-config=.
