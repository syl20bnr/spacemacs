...
add =unicode-fonts= to the existing =dotspace-macs-configuration-layers= list in this
file.

If using [[https://github.com/d12frosted/homebrew-e-macs-plus/][e-macs-plus]], you can set =unicode-fonts-force-multi-color-on-mac= to
enable color emoji.
...
If you want ligature support e-macs must be built with =Harfbuzz= and a ligature
