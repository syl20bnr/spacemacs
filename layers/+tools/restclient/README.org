...
add =restclient= to the existing =dotspace-macs-configuration-layers= list in this
file.
...
Also there is an [[http://e-macsrocks.com/e15.html][e-macs Rocks!]] episode of it.
