;;; packages.el --- systemd layer packages file for Space-macs.
;;
...
(defun systemd/post-init-flycheck ()
  (space-macs/enable-flycheck 'systemd-mode))
...
(defun systemd/init-systemd ()
  (use-package systemd
    ...
    :config (space-macs/set-leader-keys-for-major-mode 'systemd-mode
