...
add =elfeed= to the existing =dotspace-macs-configuration-layers= list in this
file.
...
#+BEGIN_SRC e-macs-lisp
  (elfeed :variables rmh-elfeed-org-files (list "~/.e-macs.d/private/elfeed1.org"
                                                "~/.e-macs.d/private/elfeed2.org"))
#+END_SRC
...
#+BEGIN_SRC org
  ...
  *** e-macs                                                    :e-macs:mustread:
  **** http://www.terminally-incoherent.com/blog/feed/
  **** http://nullprogram.com/feed/
  **** entry-title: \(e-macs\|org-mode\)
  **** https://planet.e-macslife.com/atom.xml
  *** Web Development                                                     :web:
...
in your =.space-macs= file.

#+BEGIN_SRC e-macs-lisp
  (elfeed :variables
     elfeed-feeds '(("http://nullprogram.com/feed/" blog e-macs)
...
to =t= which will start the web automatically when e-macs starts.
