...
* Table of Contents                                         :TOC_4_org:noexport:
 ...
 - [[Install][Install]]
   ...
   - [[IOSlide export support][IOSlide export support]]
...
** IOSlide export support

To enable the export of your org file as a [[https://code.google.com/p/io-2012-slides/][Google I/O HTML 5 presentation]], set the
+variable =org-enable-ioslide= to =t=. This will install the [[https://github.com/coldnew/org-ioslide][org-ioslide]] extension.
