...
(defun auto-completion/init-all-the-icons ()
  (use-package all-the-icons
    ...
    (progn
      (eval-and-compile
        ;; Icons selected by liguangsheng https://github.com/liguangsheng/emacsd/blob/master/lisp/init-completion.el
...
(defun auto-completion/init-company-box ()
  (use-package company-box
    ...
    (progn
      ...
      (add-hook 'company-box-selection-hook (lambda (selection frame) (company-box-doc--hide frame)))
      (case auto-completion-enable-help-tooltip
        ('manual (define-key company-active-map (kbd "M-h") #'company-box-doc-manually))
