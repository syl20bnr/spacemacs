...
;; State cursors
(defvar spacemacs-evil-cursors '(("normal" "DarkGoldenrod2" "#1c1c1e" box)
                                 ("insert" "chartreuse3" "#1c1c1e" (bar . 2))
                                 ("emacs" "SkyBlue2" "#1c1c1e" box)
                                 ("hybrid" "SkyBlue2" "#1c1c1e" (bar . 2))
                                 ("replace" "chocolate" "#1c1c1e" (hbar . 2))
                                 ("evilified" "LightGoldenrod3" "#1c1c1e" box)
                                 ("visual" "gray" "#1c1c1e" (hbar . 2))
                                 ("motion" "plum3" "#1c1c1e" box)
                                 ("lisp" "HotPink1" "#1c1c1e" box)
                                 ("iedit" "firebrick1" "#1c1c1e" box)
                                 ("iedit-insert" "firebrick1" "#1c1c1e" (bar . 2)))
