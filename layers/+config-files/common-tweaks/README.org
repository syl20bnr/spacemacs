...
With this tweak, the neotree window is closed when a file is opened from it.

** ct-neotree-collapse-on-parent
With this tweak, the tree's hierarchy is collapsed when going on the parent's
node.
