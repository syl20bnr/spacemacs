;;; config.el --- Julia Layer Configuration File for Space-macs
;;
...
(space-macs|define-jump-handlers julia-mode)

;; ess-mode is what the majority of people developing julia in e-macs currently use
