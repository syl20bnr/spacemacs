...
- .vue component support through [[https://github.com/AdamNiederer/vue-mode][vue-mode]]
...
| Key Binding | Description                                    |
|-------------+------------------------------------------------|
| ~SPC m '~   | edit style/script in its own (indirect) buffer |

*** Indirect buffers
Editing part of a Vue component as an indirect buffer allows Spacemacs to treat
it like a standalone file. Changes must be committed back to the file before
they can be saved.

| Key Binding                                  | Description |
|----------------------------------------------+-------------|
| ~SPC m <dotspacemacs-major-mode-leader-key>~ | confirm     |
| ~SPC m c~                                    | confirm     |
| ~SPC m a~                                    | abort       |
| ~SPC m k~                                    | abort       |
