...
** elm-format
[[https://github.com/avh4/elm-format][elm-format]] can be used to format your elm files. To install, follow the link
and download the appropriate binary or build from source.
...
** elm-format... 
| Key Binding | Description              |
| ~SPC m f f~ | elm-mode-format-buffer   |
