...
* Table of Contents                                         :TOC_4_gh:noexport:
 ...
 - [[#scalastyle][Scalastyle]]
   - [[#scalastyle-must-be-present-as-an-executable-in-your-path][Scalastyle must be present as an executable in your =PATH=]]
   - [[#enable-syntax-checking-layer-and-customize-flycheck-scalastylerc-variable][Enable =syntax-checking= layer and customize =flycheck-scalastylerc= variable]]
...
** Scalastyle must be present as an executable in your =PATH=
   - OSX users: =brew install scalastyle=
   - Linux, please see http://www.scalastyle.org/command-line.html

   To test if =scalastyle= executable is in your path, run =scalastyle= in a new terminal,
...
** Enable =syntax-checking= layer and customize =flycheck-scalastylerc= variable
   in your =dotspacemacs/layers=:
   #+BEGIN_SRC emacs-lisp
   (syntax-checking :variables
                    flycheck-scalastylerc "/usr/local/etc/scalastyle_config.xml")
   #+END_SRC

   Make sure =flycheck-scalastylerc= points to a valid location.
