...
* Table of Contents                                         :TOC_4_gh:noexport:
 ...
 - [[#key-bindings][Key Bindings]]
   ...
   - [[#formatting-web-beautify--jsfmt][Formatting (web-beautify | jsfmt)]]
...
To use the =jsfmt= formatting on file save by default, install =jsfmt= package
#+BEGIN_SRC sh
npm install -g jsfmt
#+END_SRC

And update *dotspacemacs-configuration-layers* variable from your =~/.spacemacs=
...
** Formatting (web-beautify | jsfmt)

| Key Binding | Description                                                  |
|-------------+--------------------------------------------------------------|
| ~SPC m =~   | beautify code in js2-mode, json-mode, web-mode, and css-mode |
| ~SPC m t f~ | toggle jsfmt formatting mode on file save                    |
