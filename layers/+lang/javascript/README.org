...
add =javascript= to the existing =dotspace-macs-configuration-layers= list in
this file.
...
refer to [[https://github.com/e-macs-lsp/dap-mode][dap-mode]] readme.
...
Bindings should match the plain e-macs assignments.
