...
* Backends
There are two backends available for this layer, one based on the =omnisharp-e-macs=
...
add =csharp= to the existing =dotspace-macs-configuration-layers= list in this
file.
...
[[https://github.com/OmniSharp/omnisharp-e-macs/blob/master/doc/server-installation.md][omnisharp-e-macs/doc/server-installation.md]].
