...
add =shell-scripts= to the existing =dotspace-macs-configuration-layers= list in this
file.
...
*** Shell-script-mode
This is the recommended way for working with shell scripts in e-macs. It works
by using an e-macs major mode.
