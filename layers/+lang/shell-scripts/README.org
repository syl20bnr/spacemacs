...
- [[#description][Description]]
  - [[#features][Features]]
- [[#install][Install]]
  - [[#bashisms-checking][Bashisms checking]]
  - [[#linting][Linting]]
...
- Check for bashisms in /bin/sh scripts using [[https://packages.qa.debian.org/d/devscripts.html][checkbashisms]]
...
** Bashisms checking
In order to enable bashisms checking, install [[https://packages.qa.debian.org/d/devscripts.html][checkbashisms]].
