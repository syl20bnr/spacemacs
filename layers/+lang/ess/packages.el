...
(defun ess/init-ess ()
  ...
  (with-eval-after-load 'ess-site
    ...
    (let* ((map '(","  'ess-eval-region-or-function-or-paragraph-and-step
      ...
      ;; (apply #'spacemacs/set-leader-keys-for-major-mode 'ess-julia-mode map)
      ;; (apply #'spacemacs/set-leader-keys-for-major-mode 'ess-mode       map)
      (eval `(spacemacs/set-leader-keys-for-major-mode 'ess-julia-mode ,@map))
      (eval `(spacemacs/set-leader-keys-for-major-mode 'ess-mode       ,@map)))
