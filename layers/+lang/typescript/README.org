...
add =typescript= to the existing =dotspace-macs-configuration-layers= list in this
file.

#+BEGIN_SRC e-macs-lisp
  (setq-default dotspace-macs-configuration-layers '(typescript))
#+END_SRC
...
Consult the installation command for the desired language server found at [[https://www.github.com/e-macs-lsp/lsp-mode/][lsp-mode]] for instructions.
