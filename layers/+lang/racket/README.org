...
add =racket= to the existing =dotspace-macs-configuration-layers= list in this
...
#+BEGIN_SRC e-macs-lisp
  (space-macs/toggle-evil-safe-lisp-structural-editing-on-register-hook-racket-mode)
#+END_SRC
