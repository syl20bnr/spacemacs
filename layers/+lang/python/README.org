...
If you're using the Nix package =python-language-server= (which is the Microsoft Python language server), you may also need to set the =lsp-python-ms-executable= variable:
