...
To use gometalinter, follow the instructions at
...
** GoMetaLinter
You can enable/disable linters used in the gometalinter via the variables
mentioned at https://github.com/favadi/flycheck-gometalinter#configuration , for
example:

#+begin_src emacs-lisp
  (setq-default dotspacemacs-configuration-layers
   '((go :variables flycheck-gometalinter-disable-linters ("gotype" "gocyclo"))))
#+end_src
