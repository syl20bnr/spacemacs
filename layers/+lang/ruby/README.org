...
add =ruby= to the existing =dotspace-macs-configuration-layers= list in this
file.

This layer supports two different Ruby modes: e-macs's built-in Ruby Mode and
...
#+BEGIN_SRC e-macs-lisp
  (defun dotspace-macs-configuration-layers ()
...
[[https://github.com/e-macs-lsp/dap-mode#ruby]]
...
| ~SPC m x 'â€‹~ | Change symbol or ="= string to ='=                |
| ~SPC m x "â€‹~ | Change symbol or ='= string to ="=                |
...
[[https://stackoverflow.com/questions/6453955/how-do-i-prevent-e-macs-from-adding-coding-information-in-the-first-line][The fix]] is to set the variable =ruby-insert-encoding-magic-comment= (=ruby-mode=) or =enh-ruby-add-encoding-comment-on-save= (=enh-ruby-mode=) to =nil=, e.g.
