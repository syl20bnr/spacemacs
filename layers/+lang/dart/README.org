...
add =dart= to the existing =dotspace-macs-configuration-layers= list in this
file.

#+BEGIN_SRC e-macs-lisp
  (setq-default dotspace-macs-configuration-layers '(dart))
#+END_SRC
...
language server protocol to communicate with e-macs.
