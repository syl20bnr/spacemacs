...
Then to use this configuration layer, add it to your =~/.space-macs=. You will
need to add =swift= to the existing =dotspace-macs-configuration-layers= list in
this file.
...
3. e-macs key bindings in use are the those set by the package.
