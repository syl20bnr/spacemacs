...
* Table of Contents                                         :TOC_4_gh:noexport:
 ...
 - [[#install][Install]]
   ...
   - [[#configure-debug-layer][Configure debug layer]]
...
Normally the default is ok for the debug layer. But if you want to override the gdb debugger
you can use the variable =c-c++-debugger-prog= to the full path of the executable in the dotfile:

#+BEGIN_SRC emacs-lisp
  (setq-default dotspacemacs-configuration-layers
    '((c-c++ :variables c-c++-debugger-prog "/usr/local/bin/gdb -i=mi")))
#+END_SRC
