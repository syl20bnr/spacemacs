...
To use this configuration layer, modify your =~/.spacemacs=. Below is the default configuration with added osx layer:
...
#+BEGIN_SRC emacs-lisp
   ...
   '(
     ...
     ;; auto-completion
     ;; better-defaults
     ;; (osx :variables osx-use-option-as-meta true)
     emacs-lisp
     ;; git
     ;; markdown
     ;; org
...
Instead of just osx, use this line
